...
public class AdminAddQuestionActivity extends AppCompatActivity {
    ...
    private String questionNumber, className,TestName;
    private int queNumber,classTestId,classId,schoolId,adminId;
    public static AdminAddQuestionActivity adminAddQuestionActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(AdminAddQuestionActivity.this)
                .load(AppCinfig.BASE_SCHOOL_IMAGE_URL+schoolImage)
                .into(imgSchoolLogo);

        adminAddQuestionActivity = this;
       ...
       checkInternet();
        queNumber = Integer.parseInt(questionNumber);

        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this, RecyclerView.VERTICAL, false);
        recyclerViewQuestions.setLayoutManager(layoutManager);
        list = new ArrayList<>();

        addQuestionAdapter = new AddQuestionAdapter(AdminAddQuestionActivity.this, list, btsubmit, classTestId,className,TestName,questionStatus);
    ...
    private boolean checkInternet(){
        ...
        if(isConnected) {
            GetSectionName getSectionName = new GetSectionName(AdminAddQuestionActivity.this, classTestId,tvSectionName);
    ...
    private void addQuestion(){
        ...
        for (int i = 1; i<=queNumber; i++){

            list.add(new QuestionData(i));

            if(dbHelper.insertQuestion(
                    schoolId,
                    classTestId,
                    i,
                    "null",
    ...
    List<QuestionData> questionDataList = dbHelper.getAllQuestion(schoolId, classTestId);
        ...
        if (list.size() == questionDataList.size()) {
            ...
            if (status==true) {
                            ...
                            Intent intent = new Intent(AdminAddQuestionActivity.this, AdminQuestionReviewActivity.class);
                            intent.putExtra("from", 0);
                            intent.putExtra("classTestId", classTestId);
                            intent.putExtra("className", className);
                            intent.putExtra("TestName", TestName);
                            intent.putExtra("TestName", TestName);
                            intent.putExtra("queNumber",queNumber);
                            intent.putExtra("questionStatus",questionStatus);

                AdminAddQuestionActivity.this.startActivity(intent);
            }
        }
        else {
    ...
    public void onBackPressed() {
        ...
        new AlertDialog.Builder(AdminAddQuestionActivity.this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        AdminAddQuestionActivity.super.onBackPressed();
