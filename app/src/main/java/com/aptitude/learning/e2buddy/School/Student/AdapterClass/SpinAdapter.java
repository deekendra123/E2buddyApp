...
public class SpinAdapter
        extends ArrayAdapter<SectionSubjectdata> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<SectionSubjectdata> values;

    public SpinAdapter(Context context, int textViewResourceId,
                       List<SectionSubjectdata> values) {
    ...
    @Override
    public SectionSubjectdata getItem(int position){
