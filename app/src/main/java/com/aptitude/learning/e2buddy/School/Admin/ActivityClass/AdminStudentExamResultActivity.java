...
public class AdminStudentExamResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_student_exam_result);
        ...
        studentTestAdapter = new StudentTestAdapter(AdminStudentExamResultActivity.this, list,passMarks,classTestId, dbHelper);
        ...
        GetExamSection getSectionName = new GetExamSection(AdminStudentExamResultActivity.this, classTestId,tvSectionName);
        ...
        Glide.with(AdminStudentExamResultActivity.this)
    ...
    private void getTestData(final List<StudentTestData> list, final String userNmae, final String sectionName, final int userId, final String admissionNo, String rollNo){

        MarkData markData = dbHelper.getStudentExamResult(classTestId,userId);
