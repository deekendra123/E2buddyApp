...
public class ClassSpinAdapter
        extends ArrayAdapter<ClassData> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<ClassData> values;

    public ClassSpinAdapter(Context context, int textViewResourceId,
                            List<ClassData> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getClassName());
